...
def parseXML(data_path):
    ...
    return objs
'''
[{'text': 'But the staff was so horrible to us.', 'aspects': [{'term': 'staff', 'polarity': 'negative', 'from': '8', 'to': '13'}]}, 
 {'text': "To be completely fair, the only redeeming factor was the food, which was above average, but couldn't make up for all the other deficiencies of Teodora.", 'aspects': [{'term': 'food', 'polarity': 'positive', 'from': '57', 'to': '61'}]},
 ...]
'''
